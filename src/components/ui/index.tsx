...
export function Modal({ open, onClose, title, children, footer }: ModalProps) {
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 m-auto w-full max-w-lg rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-2xl backdrop:bg-black/40 p-0 open:flex open:flex-col"
    >
      {/* header */}
